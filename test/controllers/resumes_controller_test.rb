...
class ResumesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create resume" do
    assert_difference('Resume.count') do
      post resumes_url, params: { resume: { address: @resume.address, dob: @resume.dob, email: @resume.email, name: @resume.name } }
    end
  ...
  test "should update resume" do
    patch resume_url(@resume), params: { resume: { address: @resume.address, dob: @resume.dob, email: @resume.email, name: @resume.name } }
